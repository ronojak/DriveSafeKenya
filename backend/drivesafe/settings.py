"""
Django settings for drivesafe project.
...
SECRET_KEY = 'django-insecure-=f(0h+@i*7t9r1711t^p%7p5iog+(u)egc_d#lz3f*fk%tflkc'
...
WSGI_APPLICATION = 'drivesafe.wsgi.application'
